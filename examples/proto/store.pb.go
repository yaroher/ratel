...
const file_examples_proto_store_proto_rawDesc = "" +
	...
	"\x04base\x18\x01 \x01(\v2\x11.store.BaseEntityB\x06\x82\xa6\x1d\x02 \x01R\x04base\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x1c\n" +
	"\x04slug\x18\x03 \x01(\tB\b\x9a\xb5\x18\x04\x12\x02\b\x01R\x04slug:\x12\x92\xb5\x18\b\b\x01\x12\x04tags\x82\xa6\x1d\x02\b\x01\"\xd1\x03\n" +
	"\aProduct\x12-\n" +
	...
	"\x12\bcurrency*,\x12\n" +
	"is_deleted\x12\n" +
	"created_at\"\x12is_deleted = falseB\x05store\x82\xa6\x1d\x02\b\x01\"\xcb\x03\n" +
	"\x05Order\x12-\n" +
	"\x04base\x18\x01 \x01(\v2\x11.store.BaseEntityB\x06\x82\xa6\x1d\x02 \x01R\x04base\x12(\n" +
